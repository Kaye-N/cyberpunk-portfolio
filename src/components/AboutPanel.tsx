    ...
    >
      ...
      <div className="flex flex-col sm:flex-row items-center gap-5 border-b-2 border-dashed border-zinc-800 pb-5">
        ...
        <div className="flex-1 text-center sm:text-left">
          <h2 className="font-title text-2xl sm:text-3xl text-white text-glow-white tracking-wider flex items-center justify-center sm:justify-start gap-2">
            NEONbandit <Sparkles className="w-4 h-4 text-pink-500 animate-pulse" />
          </h2>
          <div className="mt-1 font-sans text-sm sm:text-base text-zinc-400 tracking-wider flex flex-wrap items-center justify-center sm:justify-start gap-3">
      ...
      <div className="border border-zinc-800 bg-zinc-900/60 p-3 rounded-sm">
        <div className="font-title text-sm text-cyan-400 uppercase tracking-widest mb-2 flex items-center gap-1.5">
        ...
        <div className="grid grid-cols-2 xs:grid-cols-4 gap-2">
          {moods.map((m) => (
            <button
              ...
              className={`p-2 border-2 text-sm font-title uppercase flex flex-col items-center justify-center gap-1 cursor-pointer transition-all duration-200 rounded-sm ${
                mood === m.id
        ...
        <div className="mt-3 text-base text-zinc-300 tracking-wide font-medium">
          Current Mood:{" "}
          <span className="text-pink-400 uppercase font-title text-sm">
            {mood}
          </span>
        </div>
      </div>
      ...
      <div className="flex flex-col gap-2">
        <div className="flex justify-between items-center">
          <div className="font-title text-sm text-pink-500 uppercase tracking-widest">
            // PROFILE STATEMENT
          </div>
          <button
            onClick={() => setIsEditingBio(!isEditingBio)}
            className="text-sm font-title uppercase text-cyan-400 hover:text-white border border-cyan-400/40 hover:border-cyan-400 px-2 py-1 cursor-pointer rounded-sm"
          >
        ...
        {isEditingBio ? (
          <textarea
            ...
            className="w-full h-24 bg-zinc-950 border-2 border-pink-500 p-3 text-base font-sans text-white focus:outline-none focus:border-cyan-400 box-glow-cyan"
          />
        ) : (
      ...
      <div className="flex flex-col gap-2 border-t-2 border-dashed border-zinc-800 pt-5 mt-auto">
        <div className="font-title text-base text-zinc-400 uppercase tracking-widest mb-1">
        ...
        <div className="grid grid-cols-2 gap-3">
          ...
          >
            ...
            <span className="font-title text-sm tracking-wide uppercase group-hover:text-glow-pink">
              GITHUB
            </span>
          </a>
          ...
          >
            ...
            <span className="font-title text-sm tracking-wide uppercase group-hover:text-glow-cyan">
              ARTFIGHT
            </span>
          </a>
        </div>
      ...
      <div className="text-sm font-title text-zinc-500 tracking-widest flex items-center justify-center gap-1.5 uppercase mt-1">
